<script setup lang="ts">
	...
	const { benefitTab, onTabRouteHandler } = useMypageTab();

	const tabItems: {
		id: keyof typeof benefitTab;
		component: ReturnType<typeof defineAsyncComponent>;
	}[] = [
		{
			id: 'coupon',
			component: defineAsyncComponent(() => import('@/pages/mypage/components/MyBenefitCoupon.vue')),
		},
		{
			id: 'point',
			component: defineAsyncComponent(() => import('@/pages/mypage/components/MyBenefitPoint.vue')),
		}
	];
