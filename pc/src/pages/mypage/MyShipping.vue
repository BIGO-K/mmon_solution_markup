<script setup lang="ts">
	...
	const { shippingTab, onTabRouteHandler } = useMypageTab();

	const tabItems: {
		id: keyof typeof shippingTab;
		component: ReturnType<typeof defineAsyncComponent>;
	}[] = [
		{
			id: 'report',
			component: defineAsyncComponent(() => import('@/pages/mypage/components/MyShippingReport.vue')),
		},
		{
			id: 'result',
			component: defineAsyncComponent(() => import('@/pages/mypage/components/MyShippingResult.vue')),
		}
	];
