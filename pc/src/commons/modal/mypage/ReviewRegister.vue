<script setup lang="ts">
	...
	import PhysicalInfo from '@/features/personal/components/PersonalReviewPhysicalInfo.vue';
	import ProductSatisfy from '@/features/reviewTemplate/components/ReviewTemplateWrite.vue';
	...
	<ModalLayout :modal-class="'m_modal-myreview'">
		...
		<template #content>
			...
			<div class="m_modal-myreview-value">
				...
				<ProductSatisfy v-if="_isPay"></ProductSatisfy>
			</div>
			<div class="m_modal-myreview-info">
				<PhysicalInfo v-if="_isPay"></PhysicalInfo>
