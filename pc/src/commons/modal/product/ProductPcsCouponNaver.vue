...
<template>
	<ModalLayout>
		...
		<template #content>
			<div class="m_modal-prodetail-pcs T=pcs-naver">
				<h3>
					<i class="image_logo">
						<LazyloadMUI
							:_tag="'img'"
							:_src="'../image/content/logo_naver.png'"
							alt="네이버"
						></LazyloadMUI>
					</i><b>전용 쿠폰</b>
				</h3>
				...
				<div class="mm_btn_box">
					<button
						...
						class="mm_btn T=dark"
					>
						<b>지금 다운받기</b><i class="ico_download"></i>
					</button>
				</div>
...
<!-- <script>
	function closeCouponCookie() {
		...
		if (mm.find('.m_modal-prodetail-pcs [data-check]')[0].checked) {
